...
#pragma config(Motor,  port1,           LLift,         tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port2,           LFDrive,       tmotorVex393HighSpeed, openLoop)
#pragma config(Motor,  port3,           LCDrive,       tmotorVex393HighSpeed, PIDControl, encoder, encoderPort, dgtl4, 1000)
#pragma config(Motor,  port4,           LRDrive,       tmotorVex393HighSpeed, openLoop)
#pragma config(Motor,  port5,           RFDrive,       tmotorVex393HighSpeed, openLoop, reversed)
#pragma config(Motor,  port6,           RCDrive,       tmotorVex393HighSpeed, PIDControl, reversed, encoder, encoderPort, dgtl2, 1000)
#pragma config(Motor,  port7,           RRDrive,       tmotorVex393HighSpeed, openLoop, reversed)
#pragma config(Motor,  port8,           LIntake,       tmotorVex269, openLoop)
#pragma config(Motor,  port9,           RIntake,       tmotorVex269, openLoop, reversed)
#pragma config(Motor,  port10,          RLift,         tmotorVex393, openLoop)
