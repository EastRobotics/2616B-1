...
#pragma config(Motor,  port2,           LFDrive,       tmotorVex393HighSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port3,           LDDrive,       tmotorVex393HighSpeed_MC29, PIDControl, reversed, encoderPort, I2C_1)
#pragma config(Motor,  port4,           LCDrive,       tmotorVex393HighSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port5,           RFDrive,       tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port6,           RDDrive,       tmotorVex393HighSpeed_MC29, PIDControl, encoderPort, I2C_2)
#pragma config(Motor,  port7,           RCDrive,       tmotorVex393HighSpeed_MC29, openLoop)
